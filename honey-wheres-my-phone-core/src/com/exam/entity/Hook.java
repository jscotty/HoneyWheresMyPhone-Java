...
public class Hook extends Entity implements GameEventListener {
	...
	public Hook(Vector2 position, AnimationType armAnimationType, AnimationType handAnimationType,
		...
		handAnimation = (Animation) new Animation(handAnimationType, true, 0.8f, new Vector2(0, 0), manager)
				.setIndex(2);
	}
	...
	private void tweenToStartPosition() {
		Tween.to(this, AccessorReferences.POSITION, startTweenAnimationDuration).target(Main.WIDTH / 2, 1450)
